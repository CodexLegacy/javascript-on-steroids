...
const lossSound = new Audio('sounds/lossessound.mp3');
...
function showCard(card, activePlayer) {
    if (activePlayer['score'] <= 21) {
        ...
        cardImage.src = `images/img/${card}.png`;
...
// compute winner and returnwho just won
// update the wis, draws and losses
